...
import {Recover} from "./Recover.sol";
...
contract CurvyPuppetChallenge is Test {
    ...
    function test_curvyPuppet() public checkSolvedByPlayer {
        ...
        _lpToken.transferFrom(address(treasury), address(recover), TREASURY_LP_BALANCE);
        weth.transferFrom(address(treasury), address(recover), TREASURY_WETH_BALANCE);
        recover.recover();
    }
